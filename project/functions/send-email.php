...
try {
	...
	switch ($emailType) {
		...
		case 3:
			...
			$mail->Body = '<h3 ' . $hStyle . '>Want to reset your password, ' . $firstName . '? </h3> <p ' . $pStyle . '>Click the button below to <b>reset your password</b>. The link expires after you use it. In case you did not request to reset your password, you can safely ignore this email. Please keep this email confidential. </p> <a ' . $aStyle . ' href="http://localhost/topshop/functions/reset-password?customer=' . $customerID . '&code=' . $code . '">Reset Password</a>';
			break;
		case 4:
			$mail->Subject = "Password Changed";
			$mail->Body = '<h3 ' . $hStyle . '>Your password has been changed, ' . $firstName . '! </h3> <p ' . $pStyle . '>The password for your Topshop account was recently changed. <b>If you do not recognise this activity</b>, click the button below to try to sign in. <b>If you are not able to access your account</b>, click "<b>Forgot Password?</b>" on the <b>Sign In</b> page and follow the instructions there to reset your password. </p> <a ' . $aStyle . ' href="http://localhost/topshop/authenticate">Sign In</a>';
			break;
		default:
